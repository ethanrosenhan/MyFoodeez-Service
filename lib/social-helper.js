...
const getPostAccessWhere = async (userId, scope = 'mine') => {
    ...
    // post in the system, plus all of my own posts (private included), plus any
    // post I'm tagged in. This is the world-readable set the public restaurant
    // web pages (controllers/restaurant.js) expose, surfaced in-app so users
    // can see EVERY public review for a place — not just friends' — and explore
    // strangers' reviews to find new people to follow.
    if (scope === 'discover') {
